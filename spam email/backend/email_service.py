...
from backend.ml_model import load_or_train_model, predict_email

# In-memory store of app passwords keyed by EmailAccount.id.
# For production use OAuth2 — do not persist raw passwords.
